  ...
  return (
    <div className="py-24 px-6 max-w-7xl mx-auto space-y-32">
      ...
      <motion.div 
        ...
        role="list"
      >
        <div className="liquid-glass rounded-[2.5rem] p-10 text-center hover:scale-[1.02] transition-transform duration-500" role="listitem">
           <div className="w-20 h-20 rounded-full bg-blue-500/10 mx-auto mb-6 flex items-center justify-center">
             <Activity className="w-10 h-10 text-blue-500" aria-hidden="true" />
           </div>
        ...
        <div className="liquid-glass rounded-[2.5rem] p-10 text-center hover:scale-[1.02] transition-transform duration-500" role="listitem">
           <div className="w-20 h-20 rounded-full bg-purple-500/10 mx-auto mb-6 flex items-center justify-center">
             <User className="w-10 h-10 text-purple-500" aria-hidden="true" />
           </div>
        ...
        <div className="liquid-glass rounded-[2.5rem] p-10 text-center hover:scale-[1.02] transition-transform duration-500" role="listitem">
           <div className="w-20 h-20 rounded-full bg-pink-500/10 mx-auto mb-6 flex items-center justify-center">
             <Globe className="w-10 h-10 text-pink-500" aria-hidden="true" />
           </div>
      ...
      {/* Social Marquee - Decorative */}
      <div className="relative overflow-hidden py-10 border-y border-white/5 dark:border-white/5 light:border-black/5" aria-hidden="true">
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              <div className="flex gap-1 mb-6" aria-label="5 stars">
                {[1,2,3,4,5].map(star => <Star key={star} className="w-4 h-4 text-yellow-400 fill-yellow-400" aria-hidden="true" />)}
              </div>
